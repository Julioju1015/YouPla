...
const supportGuildId = 'id guild support'
const supportGuildLog= 'id channel guild support'

if(!Bottoken) throw new Error('heu token casser mdr nan eft y a pb')
//==================================================================================================================================================
//Loading Things
//==================================================================================================================================================
...
client.on("ready", () => {
    if(!supportGuildId)  throw new Error('id support pb')
    if(!supportGuildLog) throw new Error('id support channel')
